/* =========================================================================
   sidebar_module.js — ES-модуль логики сайдбара и списка адресов для Vite
   -------------------------------------------------------------------------
   Этот файл — "чистый" модуль без немедленных побочных эффектов:
     - экспортирует функции toggleSidebar, renderList и связанные хелперы;
     - ожидает, что глобальные структуры (map, ITEMS, radiusFiltered, markersCluster,
       markerMap, listMap, applyRole и т.п.) будут доступны в окружении,
       как и в текущей боевой версии;
     - пока нигде не импортируется — это задел под постепенную миграцию
       на Vite/ES-модули.
   На боевой интерфейс карты этот файл НЕ влияет.
   ========================================================================= */
